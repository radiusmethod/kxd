...
* [kxd init](kxd_init.md)	 - Print the shell integration for the given shell.
* [kxd namespace](kxd_namespace.md)	 - Kubeconfig namespace command
* [kxd shellenv](kxd_shellenv.md)	 - Print the shell code that applies ~/.kxd to the current shell.
